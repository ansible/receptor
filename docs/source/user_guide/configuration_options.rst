...
- **Timeout Start Limit**: ``RECEPTOR_KUBE_TIMEOUT_START`` values exceeding 5 minutes will be ignored and the default of 1 second will be used instead.

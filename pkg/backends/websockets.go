...
func (b *WebsocketDialer) Start(ctx context.Context, nc *netceptor.Netceptor) (chan netceptor.BackendSession, error) {
...
func (b *WebsocketListener) Start(ctx context.Context, nc *netceptor.Netceptor) (chan netceptor.BackendSession, error) {
	var err error

...
func (mr *MockNetcForTCPProxyMockRecorder) Dial(node, service, tlscfg interface{}) *gomock.Call {
...
func (mr *MockNetcForTCPProxyMockRecorder) ListenAndAdvertise(service, tlscfg, tags interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Dial indicates an expected call of Dial.
func (mr *MockNetLibMockRecorder) Dial(network, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNetLibMockRecorder) Listen(network, address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Dial indicates an expected call of Dial.
func (mr *MockTLSLibMockRecorder) Dial(network, addr, config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTLSLibMockRecorder) NewListener(inner, config interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUtilsLibMockRecorder) BridgeConns(c1, c1Name, c2, c2Name, logger interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTCPConnMockRecorder) Read(b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTCPConnMockRecorder) SetDeadline(t interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTCPConnMockRecorder) SetReadDeadline(t interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTCPConnMockRecorder) SetWriteDeadline(t interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTCPConnMockRecorder) Write(b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
func (mr *MockNetcForUDPProxyMockRecorder) ListenPacket(service interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNetcForUDPProxyMockRecorder) ListenPacketAndAdvertise(service, tags interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNetcForUDPProxyMockRecorder) NewAddr(node, service interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
